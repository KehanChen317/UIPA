...
def parse_args():
    ...
    parser.add_argument("-t", "--target_platform", type=str, help="target_platform", default="BX_Bo")
    parser.add_argument("-s", "--source_platform", type=str, help="source_platform", default="DB_Bo")
    ...
    parser.add_argument('-rl','--reg_loss_weight', type=float, help="the weight of reg_loss", default=1e-3)
    parser.add_argument('-pl','--prototype_loss_weight', type=float, help="the weight of prototype_loss", default=1e-1)
    parser.add_argument('--seed', type=int, help="seed", default=6298)
    parser.add_argument('--epochs', type=int, help="the max epoch num", default=1000)
